...
import 'rfq_quotation_model.dart';

class RfqRequestModel extends RfqRequestEntity {
  ...
  factory RfqRequestModel.fromJson(Map<String, dynamic> json) {
    ...
    return RfqRequestModel(
      ...
      deliveryCountryName: _emptyToNull(
        json['deliveryCountryName']?.toString(),
      ),
      deliveryCountryIso2Code: _emptyToNull(
        json['deliveryCountryIso2Code']?.toString(),
      ),
      deliveryCountryIso3Code: _emptyToNull(
        json['deliveryCountryIso3Code']?.toString(),
      ),
      ...
      quotations: rawQuotations is List
          ? rawQuotations
                .whereType<Map>()
                .map(
                  (item) => RfqQuotationModel.fromJson(
