...
const Map<String, Map<String, String>> _labels = {
  ...
  'unitPriceHint': {'en': 'Example: 12.50', 'ar': 'مثال: 12.50', 'fr': 'Exemple : 12.50'},
  'availableQuantityHint': {'en': 'Example: 500', 'ar': 'مثال: 500', 'fr': 'Exemple : 500'},
  'freeShippingHint': {'en': '0 for free shipping', 'ar': '0 للشحن المجاني', 'fr': '0 pour une livraison gratuite'},
  'quotationSubmittedSuccessfully': {'en': 'Quotation submitted successfully', 'ar': 'تم إرسال عرض السعر بنجاح', 'fr': 'Devis envoyé avec succès'},
  'quotationUpdatedSuccessfully': {'en': 'Quotation updated successfully', 'ar': 'تم تحديث عرض السعر بنجاح', 'fr': 'Devis mis à jour avec succès'},
  'quotationWithdrawnSuccessfully': {'en': 'Quotation withdrawn successfully', 'ar': 'تم سحب عرض السعر بنجاح', 'fr': 'Devis retiré avec succès'},
